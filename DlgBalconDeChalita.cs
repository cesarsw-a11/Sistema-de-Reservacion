...
namespace El_Balcon_de_Chalita
{
    ...
    public partial class DlgBalconDeChalita : Form
    {
...

        {
            ...
            TbxCodigo.Text = random.ToString();
        ...
        */
        ...
        private void mandarCorreo()
        {
            ...
            MailAddress para = new MailAddress(correoCliente);
            ...
            {
                Credentials = new NetworkCredential("77ec1eef62067a", "fd89d4eea6e170"),
                EnableSsl = true
            };
        ...
        private void tabPageContabilidad_Click(object sender, EventArgs e)
        {
        }
